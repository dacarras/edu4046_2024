...
- d) podemos estar estudiando cómo funciona una práctica escolar, y podríamos querer evaluar si es igual de beneficiosa para estudiantes hombres y mujeres.

- e) podríamos estar interesados en si la introducción de incentivos salariales para profesores en escuelas vulnerables fomenta la retencion en estas escuelas de modo que se asemejen más al promedio.
